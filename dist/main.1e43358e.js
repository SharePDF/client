...
exports.default = _default;
        var $43bbbc = exports.default || module.exports;
      
      if (typeof $43bbbc === 'function') {
        $43bbbc = $43bbbc.options;
      }
    
        /* template */
        Object.assign($43bbbc, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$43bbbc', $43bbbc);
          } else {
            api.reload('$43bbbc', $43bbbc);
          }
        }
